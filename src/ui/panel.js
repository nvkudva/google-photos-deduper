...
(() => {
    ...
    <div class="panel" data-ref="panel">
        ...
        <div class="controls">
          ...
          <div class="fields">
            <label class="field">
              ...
              <input type="range" class="sim" data-ref="sim" min="70" max="100" value="92" />
              <b class="simv" data-ref="simv">92%</b>
            </label>
            <label class="field">
              <span class="lbl">Scan at most</span>
              <input type="number" class="cap" data-ref="cap" value="2000" min="50" step="50" />
          ...
          <div class="srow">
            ...
            <div class="status" data-ref="status">Idle.</div>
            <button class="act sec undo" data-ref="undo" type="button" style="display:none">Undo</button>
          </div>
      ...
      <div class="ft">
        <div class="row">
          ...
          <button class="act danger del" data-ref="del" disabled>
            <span class="spin" aria-hidden="true"></span
            ><span class="dellbl" data-ref="dellbl">Move selected to bin</span>
          </button>
        </div>
      </div>
    </div>
    <div class="scanbar" data-ref="scanbar">
      <span class="msg" data-ref="scanmsg"></span>
      <button class="act sec scanstop" data-ref="scanstop" type="button">Stop</button>
    </div>
    ${preview.HTML}
  `;
  ...
  function mount() {
    ...
    // module can rely on the primitives but never restyle another module.
    style.textContent = CSS + range.CSS + preview.CSS + results.CSS;
    root.append(style);
